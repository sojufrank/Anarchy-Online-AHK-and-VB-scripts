...
Gui, Add, Text,, Press 'Home' to hotkeys turn on, Press 'End' to turn hotkeys off.
...
{
element := aoid%A_Index%
ControlClick, x900 y600, ahk_id %element%,,left
}
Return
...
{
element := aoid%A_Index%
ControlSend,ahk_parent, +{z}, ahk_id %element%
}
Return
...
{
element := aoid%A_Index%
ControlSend,ahk_parent, +{x}, ahk_id %element%
}
Return